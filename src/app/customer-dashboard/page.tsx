                            ...
                            <div className="flex items-center justify-between">
                                <CardTitle className="font-headline text-3xl flex items-baseline">
                                     <svg width="150" height="70" viewBox="0 0 170 80" className="text-primary-foreground -ml-4">
                                        ...
                                        <text x="95" y="50" fontFamily="cursive, 'Brush Script MT', 'Apple Chancery'" fontSize="35" fill="hsl(var(--primary-foreground))" dy=".3em">waters</text>
                                        <text x="115" y="68" fontFamily="sans-serif" fontSize="12" fill="hsl(var(--primary-foreground))" dy=".3em">FIT TO LIVE</text>
                                    </svg>
                                </CardTitle>
