        ...
        <CardHeader className="text-center">
            <div className="flex flex-col items-center justify-center">
                 <svg width="150" height="70" viewBox="0 0 170 80" className="text-primary">
                    ...
                    <text x="40" y="48" fontFamily="cursive, 'Brush Script MT', 'Apple Chancery'" fontSize="90" fill="hsl(var(--primary-foreground))" textAnchor="middle" dominantBaseline="central">m</text>
